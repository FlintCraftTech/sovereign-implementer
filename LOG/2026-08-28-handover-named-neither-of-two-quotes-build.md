...
Tick: done, confirmed — the read-back block carries the clause; this entry cites the capture as the recorded instance, per the reclassification rule's own requirement.
Files touched: plugin/throughliner/docs/skill-nonspecific-rules.md.
Rule gate: run — an amendment to the checkpoint's question 1 (parent named), admitted on the recorded misapplication of 2026-08-27; nothing evicted.
