...
Tick: done, confirmed — a grep for the three old offer forms returns nothing.
Files touched: plugin/throughliner/docs/plan.md, plugin/throughliner/docs/rescan.md.
Rule gate: run — a wording amendment to the existing process-now offer rules (parents named); nothing evicted.
