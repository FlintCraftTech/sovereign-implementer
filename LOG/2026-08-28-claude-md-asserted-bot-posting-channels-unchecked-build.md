# [HASH] — Capability claims get the reverse-direction check: verify the sentence before writing it
...
Tick: done, confirmed — the section carries the reverse-direction clause.
Files touched: plugin/throughliner/docs/skill-nonspecific-rules.md.
Rule gate: run — an amendment to the what-would-answer-this rule (parent named), admitted on the recorded failure of 2026-08-27; nothing evicted.
