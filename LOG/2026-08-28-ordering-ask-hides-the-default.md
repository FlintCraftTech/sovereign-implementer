...
Rule gate: run — wording amendment to beat 2's ask rule; nothing evicted.
**Queue changes:** [ordering-ask-hides-the-default] into Processed, cleared to run; SPEC.md's processing-flow sentence amended.
**Work processed:** kept — [ordering-ask-hides-the-default].
