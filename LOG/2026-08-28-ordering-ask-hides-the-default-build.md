# [HASH] — The ordering ask signals a standard exists: "shall I order them the usual way?"
...
Tick: done, confirmed — a grep for "pick the order" across the plugin returns nothing.
Files touched: plugin/throughliner/docs/plan.md, plugin/throughliner/docs/feedback-and-inbox.md, plugin/throughliner/templates/faq-template.md.
