# [HASH] — The do-not-reinstate block relocated out of the shipped close doc, as a citation of the repeal's own record
...
Tick: done, confirmed — a grep of done-plan.md for "repealed" and "do not reinstate" returns nothing.
Files touched: plugin/throughliner/docs/done-plan.md, resources/self-authoring-rules.md.
Rule gate: run — an eviction of shipped history, nothing added to the shipped docs.
