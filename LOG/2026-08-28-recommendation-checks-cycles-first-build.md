# [HASH] — Decision step reads the cycles doc before recommending, so cycle-owned artifacts stop being shaped as one-offs
...
Tick: done, confirmed — a grep for the clause's distinctive words finds exactly one site.
Files touched: plugin/throughliner/docs/plan.md.
Rule gate: run — admitted as an amendment to the decision-step cycle rules (parent named), on the recorded failure of 2026-08-28; nothing evicted; distribution plan.md.
