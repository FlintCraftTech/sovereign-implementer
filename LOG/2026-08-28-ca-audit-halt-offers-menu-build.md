...
Tick: done, confirmed — the specimen states a recommendation rather than a flat choice.
Files touched: plugin/throughliner/docs/next-audit.md.
Rule gate: run — a specimen aligned to the existing lead-with-the-recommendation rule (parent: dependency ownership); nothing evicted.
