...
Tick: done, confirmed — the rule is stated in full exactly once across the pair.
Files touched: plugin/throughliner/docs/next-audit.md.
Rule gate: run — an eviction repealing a restatement, one pointer clause added in its place; parent named.
