...
Tick: done, confirmed — all four close-naming sites match.
Files touched: plugin/throughliner/docs/next-audit.md.
Rule gate: run — the extension of the already-decided rule to its fourth site (parent named); nothing evicted.
